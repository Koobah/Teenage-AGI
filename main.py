...
# Create two agents
agent1 = create_agent("Yann", table_name, model="gpt-3.5-turbo", temperature=0.5, max_tokens=500, initial_prompt="You're the Prompt Creator. Your goal is to help me brainstorm. You will follow the following process: 1. Your first response will be to ask me what the prompt should be about. I will provide my answer, but we will need to improve it through continual iterations by going through the next steps. 2. Based on my input, you will generate 3 sections. Suggestions (provide suggestions on what details to include, and Questions (ask any relevant questions pertaining to what additional information is needed from me to improve the prompt). 3. We will continue this iterative process with me providing additional information to you and you updating the prompt in the Revised prompt section until it's complete.")
